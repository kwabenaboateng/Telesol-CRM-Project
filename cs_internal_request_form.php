...
SELECT r.id, r.department, r.requested_by, r.requestor_name, r.purpose, r.location, r.priority, r.status, r.created_at,GROUP_CONCAT(CONCAT(i.item_name, ' (', i.quantity, ')') SEPARATOR ', ') as items
    ...
    <aside class="sidebar" aria-label="Main navigation">
        ...
        <nav class="sidebar-menu">
            <ul>
                ...
                <li><a href="csdashboard.php"><i class="bi bi-speedometer2"></i> Customer Service</a></li>
                <li><a href="ticket_mgt.php"><i class="bi bi-ticket-detailed"></i> Tickets</a></li>
                ...
                <li><a href="cs_internal_request_form.php" class="active"><i class="bi bi-wrench"></i> Internal Requisition</a></li>
            ...
            <form method="post" id="requisitionForm">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="location" class="form-control" placeholder="e.g., Store, Office #">                        </div>
                    </div>
